...

{
  ...
  cards: [
    ...
    { term: 'Transverse tubules', also: ['T tubules'], def: 'the separate set of channels that invaginate from the cell membrane and carry extracellular fluid deep into a muscle fiber' },
