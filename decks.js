...
},
{
  ...
  label: {
    name: 'skullLateral',
    items: [
      { id: 'Frontal bone', name: 'Frontal bone', x: 63.6, y: 25.3, to: [90, 4], about: 'forms the forehead and the roof of each orbit' },
      { id: 'Parietal bone', name: 'Parietal bone', x: 35.7, y: 29.8, to: [10, 12.4], about: 'the paired bone forming most of the roof and upper side wall of the cranium' },
      { id: 'Temporal bone', name: 'Temporal bone', x: 44.9, y: 51.5, to: [10, 29.1], about: 'the lower side wall of the cranium; it houses the middle and inner ear' },
      { id: 'Occipital bone', name: 'Occipital bone', x: 26.1, y: 62.4, to: [10, 70.9], about: 'forms the back and much of the base of the cranium' },
      { id: 'Sphenoid bone', name: 'Sphenoid bone', x: 61.8, y: 46, to: [90, 34.7], about: 'spans the floor of the cranium; its greater wing reaches the side of the skull' },
      { id: 'Ethmoid bone', name: 'Ethmoid bone', x: 69.6, y: 45.8, to: [90, 14.2], lead: true, about: 'a light bone in the medial wall of the orbit and the roof of the nasal cavity' },
      { id: 'Lacrimal bone', name: 'Lacrimal bone', x: 71.4, y: 47.4, to: [90, 44.9], lead: true, about: 'the smallest facial bone, in the medial wall of the orbit' },
      { id: 'Nasal bone', name: 'Nasal bone', x: 77.3, y: 45.8, to: [90, 24.4], lead: true, about: 'the small paired bones forming the bridge of the nose' },
      { id: 'Zygomatic bone', name: 'Zygomatic bone', x: 68.5, y: 53.9, to: [90, 55.1], about: 'the cheekbone, forming the lateral wall and floor of the orbit' },
      { id: 'Maxilla', name: 'Maxilla', x: 73.2, y: 62.7, to: [90, 75.6], about: 'the upper jaw, carrying the upper teeth and forming most of the hard palate' },
      { id: 'Mandible', name: 'Mandible', x: 61.9, y: 78.9, to: [90, 85.8], about: 'the lower jaw, the only freely movable bone of the skull' },
      { id: 'Coronal suture', name: 'Coronal suture', x: 54.1, y: 17.7, to: [10, 4], lead: true, about: 'the immovable joint between the frontal bone and the two parietal bones' },
      { id: 'Squamous suture', name: 'Squamous suture', x: 50, y: 37.3, to: [10, 20.7], lead: true, about: 'the joint along the upper edge of the temporal bone, where it meets the parietal' },
      { id: 'Lambdoid suture', name: 'Lambdoid suture', x: 20.2, y: 53.6, to: [10, 37.5], lead: true, about: 'the joint between the occipital bone and the parietal bones' },
      { id: 'External acoustic meatus', name: 'External acoustic meatus', x: 46.1, y: 61.9, to: [10, 62.5], lead: true, about: 'the opening in the temporal bone that leads to the middle ear' },
      { id: 'Mastoid process', name: 'Mastoid process', x: 47.8, y: 72.1, to: [10, 96], lead: true, about: 'the blunt projection of the temporal bone behind the ear' },
      { id: 'Styloid process', name: 'Styloid process', x: 50, y: 71.2, to: [10, 87.6], lead: true, about: 'the slender spike below the ear, an attachment for tongue and pharynx muscles' },
      { id: 'Zygomatic process of temporal bone', name: 'Zygomatic process of temporal bone', x: 53.3, y: 57.2, to: [10, 45.8], lead: true, about: 'the rearward half of the zygomatic arch, projecting forward from the temporal bone' },
      { id: 'Temporal process of zygomatic bone', name: 'Temporal process of zygomatic bone', x: 61.4, y: 56.5, to: [90, 65.3], lead: true, about: 'the forward half of the zygomatic arch, projecting back from the cheekbone' },
      { id: 'Mandibular condyle', name: 'Mandibular condyle', x: 49.7, y: 61.4, to: [10, 54.2], lead: true, about: 'the rounded head of the mandible, which articulates with the temporal bone' },
      { id: 'Coronoid process', name: 'Coronoid process', x: 60, y: 65.7, to: [10, 79.3], lead: true, about: 'the pointed projection on the front of the mandible ramus, for the temporalis muscle' },
      { id: 'Mental foramen', name: 'Mental foramen', x: 75.7, y: 87.8, to: [90, 96], lead: true, about: 'the small opening on the front of the mandible for nerves and vessels to the chin' },
    ],
  },
  region: {
    name: 'skullLateral',
