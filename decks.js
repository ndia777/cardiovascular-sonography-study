...

{
  ...
  cards: [
    ...
    { fact: true, term: 'The two families of connective tissue proper', def: 'the loose kinds — areolar, adipose and reticular — and the dense kinds — dense regular, dense irregular and elastic' },
    { fact: true, term: 'The three loose connective tissues', def: 'areolar, adipose and reticular' },
    { fact: true, term: 'The three dense connective tissues', def: 'dense regular, dense irregular and elastic' },
  ],
},

{
  ...
  cards: [
    ...
    { term: 'Osteoblasts', def: 'the cells that DEPOSIT bone matrix, laying it down in layers called lamellae' },
    { term: 'Lamellae', def: 'the layers of matrix laid down in rings around a central canal' },
    { fact: true, term: 'The two kinds of bone', def: 'compact and spongy' },
    { fact: true, term: 'What makes up an osteon', def: 'rings of lamellae with cells between them, around a central canal carrying blood vessels — cemented together, these form compact bone' },
  ],
  questions: [
   ...
   examined separately. */
{
  ...
  cards: [
    ...
    { fact: true, term: 'The five strata of the epidermis', def: 'basale, spinosum, granulosum, lucidum, corneum — deepest first' },
    { fact: true, term: 'The two layers of the dermis', def: 'papillary above, reticular below' },
  ],
  questions: [
    ...
    { q: 'Which layer of the skin has no blood supply of its own?',
      choices: ['Epidermis', 'Dermis', 'Subcutaneous layer', 'Papillary layer'], answer: 0,
      why: 'It is fed by diffusion from the layers beneath, which is also why its outermost cells die and flake away.' },
    { q: 'From deepest to most superficial, the strata of the epidermis run:',
      choices: ['Basale, spinosum, granulosum, lucidum, corneum',
        'Corneum, lucidum, granulosum, spinosum, basale',
        'Basale, granulosum, spinosum, lucidum, corneum',
        'Spinosum, basale, granulosum, corneum, lucidum'], answer: 0,
      why: 'Only three were required for the test, but naming a set in order is a shape he uses. Lucidum appears only in thick skin — palms and soles.' },
  ],
},

{
  ...
  cards: [
    ...
    { fact: true, term: 'The two pigments of skin and hair', def: 'eumelanin, brownish-black, and pheomelanin, reddish-yellow' },
    { fact: true, term: 'The three skin cancers', def: 'basal cell carcinoma, squamous cell carcinoma and malignant melanoma' },
  ],
  questions: [
    ...
    { q: 'Which pigment gives skin and hair their brownish-black colour?',
      choices: ['Eumelanin', 'Pheomelanin', 'Carotene', 'Keratin'], answer: 0,
      why: 'Pheomelanin is the reddish-yellow one. Keratin is a protein, not a pigment at all — the sort of near-miss that belongs in the same options list.' },
    { q: 'A patient’s skin takes on a bluish cast. This is:',
      choices: ['Cyanosis', 'Erythema', 'Jaundice', 'Albinism'], answer: 0,
      why: 'Bluish means poorly oxygenated blood showing through. The others are the same kind of colour-change term, which is exactly how he builds a distractor list.' },
  ],
},

{
  ...
  cards: [
    ...
    { fact: true, term: 'The four glands of the skin', def: 'sebaceous, eccrine, apocrine and ceruminous' },
    { fact: true, term: 'The two sweat glands', def: 'eccrine, which answer to heat, and apocrine, which answer to emotion' },
  ],
  questions: [
    ...
    { q: 'Which gland releases an oily secretion onto the hair follicle?',
      choices: ['Sebaceous', 'Eccrine', 'Apocrine', 'Ceruminous'], answer: 0,
      why: 'Sebum lubricates hair and skin, and being slightly acidic it discourages bacteria. The other three are the rest of the set.' },
    { q: 'Which structure contracts to raise a goosebump?',
      choices: ['Arrector pili', 'Hair bulb', 'Hair papilla', 'Sebaceous gland'], answer: 0,
      why: 'A small muscle on the follicle. It pulls the hair upright in cold or fright, which reduces heat loss.' },
  ],
},

{
  ...
  cards: [
    ...
    { fact: true, term: 'The four routes of heat loss', def: 'radiation, conduction, convection and evaporation' },
  ],
  questions: [
    ...
    { q: 'Heat carried away as air warms, moves off, and is replaced by cooler air is:',
      choices: ['Convection', 'Conduction', 'Radiation', 'Evaporation'], answer: 0,
      why: 'Conduction is direct contact; radiation needs no contact at all; evaporation is sweat turning to vapour. All four are one set, so learn them against each other.' },
  ],
},

{
  ...
  cards: [
    ...
    { fact: true, term: 'The three depths of burn', def: 'superficial partial-thickness, deep partial-thickness and full-thickness' },
    { fact: true, term: 'The two skin grafts', def: 'an autograft, taken from the patient, and an allograft, taken from another person' },
  ],
  questions: [
    ...
    { q: 'A burn destroying the whole outer layer and part of the layer beneath, often blistering, is:',
      choices: ['Deep partial-thickness', 'Superficial partial-thickness', 'Full-thickness', 'Superficial full-thickness'], answer: 0,
      why: 'It can still regenerate, because stem cells survive in the follicles and glands. A full-thickness burn destroys those too and heals only from the margins.' },
    { q: 'Which of these sits in the dermis rather than the epidermis?',
      choices: ['Lamellated corpuscle', 'Melanocyte', 'Keratinocyte', 'Tactile cell'], answer: 0,
      why: 'The other three all live in the epidermis. He draws distractors from elsewhere in the chapter, so knowing which structure sits in which layer is its own skill.' },
  ],
},
...

{
  ...
  source: 'Chapter 49 — Medical Assisting: Administrative & Clinical Competencies',
  cards: [
    { term: 'Pharmacology', def: 'the study of drugs' },
    { term: 'Therapeutic response', def: 'the desired effect of a drug, the one that helps treat or cure' },
    { term: 'What drugs cannot do', fact: true, def: 'restore lost function of an organ damaged beyond repair — they can only enhance what remains, or replace what the body no longer produces' },
    { term: 'Chemotherapeutic drugs', def: 'the group that cures disease caused by an infectious organism, or treats cancer' },
    { term: 'Pharmacodynamic drugs', def: 'the group treating NON-infectious processes, by suppressing chemicals the body releases in excess or boosting ones it makes too little of' },
    { term: 'Miscellaneous agents', def: 'the group holding everything not classified elsewhere — certain pain relievers, smoking cessation agents, antipsoriatics' },
    { term: 'Agonist', def: 'a drug that stimulates the action of a receptor site' },
    { term: 'Antagonist', def: 'a drug that blocks or prevents an action at a receptor site' },
    { term: 'Synergistic', def: 'describing drugs that enhance or multiply each other’s effects' },
    { term: 'Additive effects', def: 'the result when two drugs are taken together and their effects simply add to one another' },
    { term: 'Local effect', def: 'a drug effect restricted to the area where it was administered' },
    { term: 'Remote effect', def: 'a drug effect taking place somewhere other than the site of administration' },
    { term: 'Systemic effect', def: 'a drug effect generalized throughout the body' },
    { term: 'Tolerance', def: 'the state after long use where a larger dose, or a different drug, is needed for the same effect' },
    { term: 'Medication allergy', def: 'an immune reaction to a drug, which can appear at any time — even to one taken before without trouble' },
    { term: 'Intolerance', def: 'an undesirable response such as nausea or upset stomach that is NOT a true allergic reaction',
      note: 'Still charted. Patients quietly stop taking medicines that make them feel bad, so timing advice keeps them on the therapy.' },
    { term: 'Chemical name', def: 'the name describing a drug’s atomic or molecular structure, assigned when it is first discovered' },
    { term: 'Generic name', also: ['official name'], def: 'the name assigned by the USAN Council once the FDA approves a drug — and it is NOT capitalized' },
    { term: 'Trade name', def: 'the brand name the manufacturer assigns for marketing, approved by the FDA, and it IS capitalized' },
    { term: 'How long a new drug holds non-compete status', fact: true, def: 'seven years, so the manufacturer can recover development costs before a generic may be produced' },
    { term: 'Orphan drug', def: 'the only approved drug available for a given indication, which is the exception to the seven-year rule' },
    { term: 'Over-the-counter (OTC)', def: 'drugs considered safe and effective for the general population without a prescription' },
    { term: 'Recall', def: 'a voluntary act by the manufacturer on the FDA’s recommendation — sometimes because labeling was inaccurate rather than because the drug was unsafe' },
    { term: 'Controlled substance', def: 'any drug, prescription or illegal, with the potential for abuse or addiction' },
    { term: 'Controlled Substances Act', def: 'the 1970 law that established the DEA, controlled prescriptions for commonly abused drugs, and required prescribers to register for individual DEA numbers' },
    { term: 'Drug Enforcement Administration (DEA)', def: 'the agency under the Department of Justice overseeing controlled substances and issuing prescriber numbers' },
    { term: 'Schedule I', def: 'high abuse potential, NO accepted medical use in the United States — prescriptions are prohibited; heroin, LSD, ecstasy' },
    { term: 'Schedule II', def: 'high abuse potential but accepted medical use, tightly restricted — written order with signature and DEA number, and NO refills; morphine, cocaine, Demerol' },
    { term: 'Schedule III', def: 'low to moderate abuse potential — may be written or phoned in, refilled five times within six months; anabolic steroids, certain opioids' },
    { term: 'Schedule IV', def: 'low abuse potential — refilled up to five times in six months; Xanax, Tramadol, phenobarbital' },
    { term: 'Schedule V', def: 'low abuse potential, subject to state and local regulation — a written prescription may not even be required; small amounts of codeine in cough preparations' },
    { term: 'Emergency Schedule II order', fact: true, def: 'the provider may phone in a limited amount, but the written signed prescription must reach the pharmacist within 72 hours',
      note: 'That is the figure this textbook gives. Current federal regulation (21 CFR 1306.11) allows seven days — the 72-hour figure is the older rule. Answer the way the course teaches it.' },
    { term: 'Controlled substance symbol', def: 'a C with the Roman numeral of the schedule inside it, printed on schedules II through V' },
    { term: 'How often DEA registration is renewed', fact: true, def: 'every three years, and the certificate must be displayed at every place of practice where controlled substances are prescribed' },
    { term: 'Double lock', def: 'the storage requirement for controlled substances — two locks, such as an outer and inner cabinet, with key possession recorded daily' },
    { term: 'Where controlled substances may NOT be stored', fact: true, def: 'in the same compartment or cabinet as uncontrolled pharmaceuticals' },
    { term: 'Prescriber’s Digital Reference (PDR)', def: 'the online drug reference at pdr.net, formerly the Physician’s Desk Reference, whose last print edition was 2017' },
    { term: 'Dispense as written (DAW)', def: 'the prescriber’s instruction that the pharmacist may not substitute a generic' },
    { term: 'Off-label use', def: 'prescribing a drug for a condition other than the one it was approved for — not improper, it means controlled trials were not done for that indication' },
    { term: 'How quantity must appear on a controlled substance prescription', fact: true, def: 'in BOTH numerical and written form, and the document may contain no other drug' },
    { term: 'The biggest benefit of e-prescribing', fact: true, def: 'eliminating the errors caused by illegible handwriting' },
  ],
  questions: [
    { q: 'A drug that blocks an action at a receptor site is a:',
      choices: ['Antagonist', 'Agonist', 'Synergist', 'Catalyst'], answer: 0,
      why: 'Agonist stimulates, antagonist blocks. Synergistic is a different idea — two drugs multiplying each other’s effects.' },
    { q: 'Which schedule may NOT be refilled at all?',
      choices: ['Schedule II', 'Schedule III', 'Schedule IV', 'Schedule V'], answer: 0,
      why: 'Schedule II needs a written order with the prescriber’s signature and DEA number, and no refills. III and IV allow five refills in six months.' },
    { q: 'A patient reports nausea after starting a new medication, with no rash, swelling or breathing trouble. This is best charted as:',
      choices: ['An intolerance', 'An allergy', 'An adverse event requiring VAERS', 'A synergistic effect'], answer: 0,
      why: 'Intolerance is an undesirable effect without an immune reaction. It still gets charted — but calling it an allergy could wrongly rule the drug out for life.' },
    { q: 'Generic and trade names differ in capitalization how?',
      choices: ['Trade names are capitalized; generic names are not', 'Generic names are capitalized; trade names are not', 'Both are capitalized', 'Neither is capitalized'], answer: 0,
      why: 'The manufacturer’s brand gets the capital letter. The USAN Council’s generic name does not.' },
    { q: 'Dietary supplements differ from medications in that they:',
      choices: ['Are not regulated by the FDA', 'Must be proven safe before sale', 'Require a prescription', 'Are approved faster'], answer: 0,
      why: 'Both prescription and OTC medications must be proven safe and effective first. Supplements have no such requirement — which is why the provider must know what the patient is taking.' },
  ],
},

{
  ...
  source: 'Chapter 51 — Medical Assisting: Administrative & Clinical Competencies',
  cards: [
    { term: 'The seven rights', fact: true, def: 'right patient, right medication, right dose, right route, right time, right documentation, and right technique' },
    { term: 'Right technique', def: 'the seventh right — HOW the medication is given, the skill of the injection or the way a topical is applied' },
    { term: 'Right documentation', def: 'recording the medication completely and correctly after it is given' },
    { term: 'How many times the medication label is checked', fact: true, def: 'four times — three before administration and once after' },
    { term: 'How to confirm the right patient', fact: true, def: 'have the patient state their full name plus one other identifier, never asking a question that can be answered yes or no' },
    { term: 'Medication order', def: 'a direct and complete instruction from the provider for giving a drug WHILE the patient is in the office or facility',
      note: 'A prescription is taken away and filled; this is carried out on site.' },
    { term: 'What to do with an incomplete or unclear order', fact: true, def: 'do not carry it out until it has been clarified' },
    { term: 'Parenteral', def: 'any route of administration outside the digestive tract' },
    { term: 'Biotransformation', def: 'how the body converts a drug into a form it can use' },
    { term: 'Buccal', def: 'medication placed between the cheek and the gum, absorbed through the mucous membranes' },
    { term: 'Sublingual', def: 'medication placed under the tongue for rapid absorption through the mucous membranes — nitroglycerine for angina is the example' },
    { term: 'Topical', def: 'applied directly to the skin' },
    { term: 'Transdermal', def: 'an adhesive patch worn on the skin delivering a time-released dose over days or weeks' },
    { term: 'Suppositories', def: 'conical or ovoid solids that melt at body temperature, inserted rectally, vaginally or urethrally' },
    { term: 'Enemas', def: 'liquids delivered into the rectum through a flexible tube' },
    { term: 'Intradermal', def: 'a shallow-angle injection just under the dermis' },
    { term: 'Intraosseous', def: 'delivery directly into bone marrow — used in emergencies when no other route is available' },
    { term: 'Intrathecal', def: 'delivery into the spinal canal by injection or infusion' },
    { term: 'Routes the medical assistant may administer', fact: true, def: 'oral, inhaled, topical, rectal, vaginal, urethral and injectable — unless state law says otherwise' },
    { term: 'What counts as a medication error', fact: true, def: 'right drug to the wrong patient, wrong drug to the right patient, wrong dose, wrong documentation, wrong route, or wrong time' },
    { term: 'What to do when a medication error is made', fact: true, def: 'never cover it up — notify the prescriber or supervising practitioner at once, because only the ordering provider decides the plan of care' },
    { term: 'Lot number', def: 'the batch identifier on an immunization, used to track and report adverse events back to the manufacturer' },
    { term: 'What immunizations require beyond ordinary documentation', fact: true, def: 'the manufacturer, the lot number, the serial number if applicable, and the container’s expiration date' },
    { term: 'VAERS', also: ['Vaccine Adverse Event Reporting System'], def: 'the FDA and CDC programme for reporting adverse events after vaccination',
      note: 'Anyone may submit a report, not just providers — and it does not determine causality, it collects information for investigation.' },
    { term: 'National Childhood Vaccine Injury Act (NCVIA)', def: 'the law requiring written information be given to the patient, or a minor’s parent, BEFORE immunizing' },
    { term: 'Institute for Safe Medication Practices (ISMP)', def: 'the body publishing the list of error-prone abbreviations, symbols and dose designations' },
    { term: 'The Joint Commission’s "Do Not Use" list', def: 'the list of abbreviations that most commonly lead to medication errors, which practices are told to avoid' },
    { term: 'What to do when unsure of an abbreviation', fact: true, def: 'spell the word out — there is no comprehensive list of approved abbreviations' },
    { term: 'Earlobe traction for eardrops', fact: true, def: 'pull UPWARD to straighten the canal — but DOWNWARD in patients under the age of three' },
    { term: 'Where eyedrops are placed', fact: true, def: 'in the inner canthus, one at a time, followed by gentle pressure so they do not drain into the tear duct' },
    { term: 'Position for a rectal suppository', fact: true, def: 'on the LEFT side with the knees drawn toward the chest, inserted just past the anal sphincter with gentle pressure held' },
    { term: 'Why nitroglycerin ointment is rotated', fact: true, def: 'the old dose is removed on schedule and the area cleaned before the next is applied elsewhere, or an unsafe excess becomes available for absorption' },
    { term: 'Why gloves are worn to apply a transdermal patch', fact: true, def: 'a priming dose sits in the adhesive edge, and inadvertent transfer to the person applying it ranges from undesirable to dangerous' },
    { term: 'Why the mouth is rinsed after a metered dose inhaler', fact: true, def: 'to prevent fungal infections' },
    { term: 'How oxygen is prescribed', fact: true, def: 'by delivery method — nasal cannula or mask — and by rate in liters per minute (LPM)' },
    { term: 'Why an anti-itch topical is applied with gentle strokes', fact: true, def: 'rubbing vigorously makes the itching worse, because friction produces heat' },
    { term: 'ac', def: 'before meals' },
    { term: 'pc', def: 'after meals' },
    { term: 'NPO', def: 'nothing by mouth' },
    { term: 'PRN', def: 'as needed' },
    { term: 'STAT', def: 'immediately' },
    { term: 'po', def: 'by mouth' },
    { term: 'gtt', def: 'drop' },
    { term: 'BID', def: 'twice daily' },
    { term: 'TID', def: 'three times daily' },
    { term: 'QID', def: 'four times daily' },
  ],
  questions: [
    { q: 'Which route places the medication between the cheek and gum?',
      choices: ['Buccal', 'Sublingual', 'Topical', 'Otic'], answer: 0,
      why: 'Sublingual is UNDER the tongue. Both absorb through the mucous membranes, which is why they act fast.' },
    { q: 'You are instilling eardrops in a two-year-old. Which way do you pull the earlobe?',
      choices: ['Downward', 'Upward', 'Straight back', 'No traction is used'], answer: 0,
      why: 'Upward is the adult technique; under the age of three it is downward. The point either way is to straighten the canal.' },
    { q: 'A medication error has been made. What comes first?',
      choices: ['Notify the prescriber or supervising practitioner at once', 'Document it and continue', 'Correct the chart entry', 'Observe the patient and report only if symptoms appear'], answer: 0,
      why: 'Never cover it up. Many errors need only monitoring and some need emergency intervention — but only the ordering provider decides which.' },
    { q: 'A medication order differs from a prescription in that it:',
      choices: ['Is for a medication given while the patient is in the office or facility', 'Must be written by a pharmacist', 'Cannot include a controlled substance', 'Is never entered in the chart'], answer: 0,
      why: 'A prescription is taken away and filled. An order is carried out on site, which is why the person administering it is responsible for checking it is complete.' },
    { q: 'Which of these is required when documenting an immunization but NOT an ordinary medication?',
      choices: ['Lot number', 'Route of administration', 'Time administered', 'Patient date of birth'], answer: 0,
      why: 'Lot numbers let the manufacturer trace adverse events back to a batch. Manufacturer, serial number and expiration date come with it.' },
  ],
},
{
  id: 'mt3-parts',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 3 — Skeletal: Word Parts',
  source: 'Chapter 3 — course notes',
  cards: [
    { term: 'ankyl/o', def: 'crooked, bent or stiff' },
    { term: 'arthr/o', def: 'joint' },
    { term: 'burs/o', def: 'the fluid-filled sac that cushions areas subject to friction' },
    { term: 'chondr/i, chondr/o', def: 'cartilage' },
    { term: 'cost/o', def: 'rib' },
    { term: 'crani/o', def: 'skull' },
    { term: '-desis', def: 'to bind or tie together' },
    { term: 'kyph/o', def: 'hump' },
    { term: 'lord/o', def: 'bent backward' },
    { term: 'lumb/o', def: 'lower back' },
    { term: 'myel/o', def: 'bone marrow — and also spinal cord' },
    { term: 'oss/e, oss/i, ost/o, oste/o', def: 'bone' },
    { term: 'scoli/o', def: 'curved' },
    { term: 'spondyl/o', def: 'vertebrae' },
    { term: 'synovi/o, synov/o', def: 'the membrane lining a freely movable joint, and the lubricant it secretes' },
    { term: 'ligament/o', def: 'the fibrous band connecting one bone to another' },
    { fact: true, term: 'The four roots that all mean bone', def: 'oss/e, oss/i, ost/o and oste/o' },
    { fact: true, term: 'The three curvature roots', def: 'kyph/o hump, lord/o bent backward, scoli/o curved — all three take -osis' },
    { fact: true, term: 'The root with two unrelated meanings', def: 'myel/o, which means bone marrow in this chapter but spinal cord elsewhere',
      note: 'Worth pinning down now — my/o (muscle) in Chapter 4 looks almost identical and means something else again.' }
  ],
  questions: [
    { q: 'Arthrodesis breaks down into which parts?',
      choices: ['arthr/o (joint) + -desis (to bind together) — surgical fusion of a joint',
        'arthr/o (joint) + -desis (to cut) — surgical opening of a joint',
        'arthr/o (bone) + -desis (to bind together) — fusion of two bones',
        'arthr/o (cartilage) + -desis (to bind together) — cartilage repair'], answer: 0,
      why: 'The suffix -desis always means binding or tying together. It turns up again in Chapter 4 as tenodesis, tying a tendon to a bone.' },
    { q: 'Which root means crooked, bent or stiff?',
      choices: ['ankyl/o', 'lord/o', 'scoli/o', 'kyph/o'], answer: 0,
      why: 'Ankylosis is the loss of mobility in a joint. The other three are the spinal curvature roots, which is exactly why they make good wrong answers.' },
    { q: 'Costochondritis is inflammation of what?',
      choices: ['The cartilage connecting a rib to the sternum', 'The lining of a joint',
        'The bone marrow', 'The covering of a bone'], answer: 0,
      why: 'cost/o (rib) + chondr (cartilage) + -itis (inflammation). Two roots stacked before the suffix.' },
    { q: 'A term built on spondyl/o refers to which structure?',
      choices: ['Vertebrae', 'The skull', 'The lower back', 'A bursa'], answer: 0,
      why: 'Spondylosis, spondylolisthesis and ankylosing spondylitis all concern the vertebrae. Note lumb/o also points at the back, but means the region, not the bones.' }
  ]
},
{
  id: 'mt3-structure',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 3 — Bone Structure & Joints',
  source: 'Chapter 3 — course notes',
  cards: [
    { term: 'Ossification', def: 'the process through which cartilage is turned into bone' },
    { term: 'Osteoblasts', def: 'the cells that help rebuild bone' },
    { term: 'Osteoclasts', def: 'the cells that break down old or damaged bone' },
    { term: 'Periosteum', def: 'the tough, fibrous tissue forming the outermost covering of a bone' },
    { term: 'Compact bone, cortical bone', def: 'the dense, hard, very strong tissue forming the protective outer layer — more than 75% of the body\'s bone matter by weight' },
    { term: 'Spongy bone, cancellous bone', def: 'the porous tissue that is lighter and weaker, and commonly holds red marrow' },
    { term: 'Medullary cavity', def: 'the central space in the shaft of a long bone where marrow is stored' },
    { term: 'Endosteum', def: 'the tissue lining the medullary cavity' },
    { term: 'Red bone marrow', def: 'the hematopoietic tissue that manufactures red blood cells, hemoglobin, white blood cells and thrombocytes' },
    { term: 'Yellow bone marrow', def: 'the fat storage tissue that gradually replaces about half of the red variety after early adolescence' },
    { term: 'Hematopoietic', def: 'pertaining to the formation of blood cells' },
    { term: 'Cartilage', def: 'smooth, rubbery, blue-white connective tissue acting as a shock absorber between bones' },
    { term: 'Articular cartilage', def: 'the covering on bone surfaces where they meet, protecting them from rubbing together' },
    { term: 'Meniscus', def: 'the curved, fibrous pad found in some joints, such as the knee and the jaw' },
    { term: 'Diaphysis', def: 'the shaft of a long bone' },
    { term: 'Epiphyses', def: 'the wider ends of a long bone' },
    { term: 'Foramen', def: 'an opening through which blood vessels, nerves and ligaments pass' },
    { term: 'Process', def: 'a normal projection on a bone surface, most often an attachment point for a muscle or tendon' },
    { term: 'Joints, articulations', def: 'the places of union between two or more bones' },
    { term: 'Fibrous joints', def: 'those holding bones tightly together with inflexible layers of dense connective tissue' },
    { term: 'Sutures', def: 'the immovable fibrous joints of the adult skull' },
    { term: 'Fontanelles', def: 'the soft spots of a newborn skull, which allow passage through the birth canal and growth during the first year' },
    { term: 'Cartilaginous joints', def: 'those allowing only slight movement, where bones are connected entirely by cartilage' },
    { term: 'Pubic symphysis', def: 'the slightly movable union between the pubic bones at the front of the pelvis' },
    { term: 'Synovial joints', def: 'the freely movable ones' },
    { term: 'Ball-and-socket joint', def: 'the type allowing a wide range of movement in many directions, as at the hips and shoulders' },
    { term: 'Hinge joint', def: 'the type allowing movement primarily in one direction or plane, as at the knees and elbows' },
    { term: 'Bursa', def: 'the fluid-filled sac cushioning an area subject to friction during movement' },
    { fact: true, term: 'The three types of joints', def: 'fibrous, cartilaginous and synovial' },
    { fact: true, term: 'The two types of synovial joint named in this chapter', def: 'ball-and-socket and hinge' }
  ],
  questions: [
    { q: 'Which type of joint allows only slight movement?',
      choices: ['Cartilaginous', 'Fibrous', 'Synovial', 'Ball-and-socket'], answer: 0,
      why: 'Fibrous allows little or none, synovial allows free movement, so cartilaginous is the middle of the set. The ribs joining the sternum are the example.' },
    { q: 'Which cells break bone down, rather than build it up?',
      choices: ['Osteoclasts', 'Osteoblasts', 'Chondrocytes', 'Thrombocytes'], answer: 0,
      why: 'Clasts clear away, blasts build. They work as a pair throughout life, not only during growth.' },
    { q: 'Red bone marrow is found within which tissue?',
      choices: ['Spongy bone', 'Compact bone', 'Articular cartilage', 'The periosteum'], answer: 0,
      why: 'Its porous structure houses the blood-forming tissue. That is also why spongy bone is lighter and more prone to fracture.' },
    { q: 'The soft spots on a newborn skull are called:',
      choices: ['Fontanelles', 'Sutures', 'Foramina', 'Processes'], answer: 0,
      why: 'They are fibrous joints that have not yet hardened. In an adult the same joints are sutures.' }
  ]
},
{
  id: 'mt3-skeleton',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 3 — The Skeleton',
  source: 'Chapter 3 — course notes',
  cards: [
    { term: 'Axial skeleton', def: 'the 80 bones protecting the major organs of the nervous, respiratory and circulatory systems' },
    { term: 'Appendicular skeleton', def: 'the 126 bones making body movement possible and protecting the organs of digestion, excretion and reproduction' },
    { term: 'Cranium', def: 'the frontal, parietal, occipital, sphenoid and ethmoid bones, which enclose and protect the brain' },
    { term: 'Auditory ossicles', def: 'the malleus, incus and stapes — three tiny bones in the middle ear' },
    { term: 'True ribs', def: 'the first seven pairs, attached anteriorly to the sternum' },
    { term: 'False ribs', def: 'the next three pairs, attached anteriorly to cartilage rather than directly to the sternum' },
    { term: 'Floating ribs', def: 'the last two pairs, attached only posteriorly to the vertebrae' },
    { term: 'Manubrium', def: 'the upper portion of the sternum' },
    { term: 'Xiphoid process', def: 'the cartilage forming the lower portion of the sternum' },
    { term: 'Clavicle', def: 'the collarbone' },
    { term: 'Scapula', def: 'the shoulder blade' },
    { term: 'Humerus', def: 'the bone of the upper arm' },
    { term: 'Radius', def: 'the smaller, shorter of the two forearm bones' },
    { term: 'Ulna', def: 'the larger, longer of the two forearm bones' },
    { term: 'Olecranon', def: 'the proximal tip of the ulna, known as the funny bone' },
    { term: 'Carpals', def: 'the eight bones forming the wrist' },
    { term: 'Metacarpals', def: 'the five bones forming the palm of the hand' },
    { term: 'Phalanges', def: 'the bones of the fingers and toes' },
    { term: 'Cervical vertebrae', def: 'the first seven, which form the neck' },
    { term: 'Thoracic vertebrae', def: 'T1 through T12, which have the ribs attached' },
    { term: 'Lumbar vertebrae', def: 'L1 through L5, which form an inward curve' },
    { term: 'Sacrum', def: 'the triangular bone near the base of the spine' },
    { term: 'Coccyx', def: 'the tailbone' },
    { term: 'Lamina', def: 'the posterior portion of a vertebra' },
    { term: 'Intervertebral disks', def: 'the cartilage pads separating and cushioning the vertebrae, allowing movement' },
    { term: 'Pelvic girdle', def: 'the ilium, ischium and pubis' },
    { term: 'Acetabulum', def: 'the hip socket' },
    { term: 'Femur', def: 'the thigh bone, and the largest in the body' },
    { term: 'Patella', def: 'the kneecap' },
    { term: 'Popliteal', def: 'the space behind the knee' },
    { term: 'Tibia', def: 'the shinbone — the larger, anterior weight-bearing bone of the lower leg' },
    { term: 'Fibula', def: 'the smaller of the two bones of the lower leg' },
    { term: 'Tarsals', def: 'the bones of the ankle' },
    { term: 'Malleolus', def: 'a rounded bony projection, such as those on either side of the ankle' },
    { term: 'Calcaneus', def: 'the heel bone, and the largest of the tarsals' },
    { term: 'Metatarsals', def: 'the bones forming the part of the foot the toes attach to' },
    { fact: true, term: 'The five parts of the axial skeleton', def: 'the skull, the ossicles of the middle ear, the hyoid bone, the rib cage and the vertebral column' },
    { fact: true, term: 'The three auditory ossicles', def: 'malleus, incus and stapes' },
    { fact: true, term: 'The three pelvic girdle bones', def: 'ilium, ischium and pubis' },
    { fact: true, term: 'The three rib categories', def: 'true (7 pairs), false (3 pairs) and floating (2 pairs)' },
    { fact: true, term: 'How many bones in a typical adult skeleton', def: 'about 206 — 80 axial and 126 appendicular' }
  ],
  questions: [
    { q: 'Which forearm bone is the larger and longer of the two?',
      choices: ['Ulna', 'Radius', 'Humerus', 'Olecranon'], answer: 0,
      why: 'The radius is the shorter one, on the thumb side. The olecranon is a part of the ulna rather than a separate bone.' },
    { q: 'Ribs attached only to the vertebrae, with no anterior attachment, are:',
      choices: ['Floating ribs', 'False ribs', 'True ribs', 'Costal ribs'], answer: 0,
      why: 'False ribs do attach anteriorly, just to cartilage rather than the sternum. That distinction is the whole point of the three-way split.' },
    { q: 'The hip socket is known as the:',
      choices: ['Acetabulum', 'Ilium', 'Pubic symphysis', 'Sacroiliac'], answer: 0,
      why: 'The ilium is one of the three girdle bones; the other two options are joints. Only one of the four names a socket.' },
    { q: 'Which vertebrae have ribs attached?',
      choices: ['Thoracic', 'Cervical', 'Lumbar', 'Sacral'], answer: 0,
      why: 'T1 through T12. Cervical form the neck, lumbar the lower back — knowing the order down the spine answers most questions of this shape.' },
    { q: 'How many bones form the wrist?',
      choices: ['Eight', 'Five', 'Fourteen', 'Seven'], answer: 0,
      why: 'Eight carpals, five metacarpals in the palm, fourteen phalanges in the fingers. The three numbers are worth learning together.' }
  ]
},
{
  id: 'mt3-pathology',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 3 — Skeletal Pathology',
  source: 'Chapter 3 — course notes',
  cards: [
    { term: 'Ankylosis', def: 'the loss or absence of mobility in a joint' },
    { term: 'Adhesive capsulitis', def: 'frozen shoulder, caused by adhesions' },
    { term: 'Bursitis', def: 'inflammation of the sac that cushions a joint' },
    { term: 'Chondromalacia', def: 'abnormal softening of cartilage' },
    { term: 'Costochondritis', def: 'inflammation of the cartilage connecting a rib to the sternum' },
    { term: 'Hallux valgus', def: 'a bunion — abnormal enlargement of the joint at the base of the great toe' },
    { term: 'Hemarthrosis', def: 'blood within a joint' },
    { term: 'Synovitis', def: 'inflammation of the membrane lining a freely movable joint' },
    { term: 'Baker\'s cyst', def: 'a fluid-filled sac behind the knee' },
    { term: 'Dislocation, luxation', def: 'the total displacement of a bone from its joint' },
    { term: 'Subluxation', def: 'the partial displacement of a bone from its joint' },
    { term: 'Sprain', def: 'an injury in which a ligament is wrenched or torn' },
    { term: 'Osteoarthritis', def: 'wear-and-tear degenerative joint disease' },
    { term: 'Osteophytes', def: 'bone spurs' },
    { term: 'Spondylosis', def: 'osteoarthritis of the spine' },
    { term: 'Gout', def: 'a form of arthritis caused by deposits of urate crystals in the joints' },
    { term: 'Pseudogout', def: 'the buildup of calcium pyrophosphate crystals in a joint' },
    { term: 'Rheumatoid arthritis', def: 'a chronic autoimmune disorder attacking the joints and some organs of other systems' },
    { term: 'Ankylosing spondylitis', def: 'inflammation of the joints between the vertebrae' },
    { term: 'Kyphosis', def: 'hunchback — an abnormal outward curvature of the upper spine' },
    { term: 'Lordosis', def: 'swayback — an abnormal forward curvature of the lower spine' },
    { term: 'Scoliosis', def: 'an abnormal sideways curvature of the spine' },
    { term: 'Herniated disk', def: 'the rupture of the cartilage pad between two vertebrae' },
    { term: 'Lumbago', def: 'pain in the lower back' },
    { term: 'Spondylolisthesis', def: 'the forward slipping of a lower lumbar vertebra on the one below it' },
    { term: 'Spina bifida', def: 'a congenital defect in which the spinal canal fails to close completely' },
    { term: 'Spinal stenosis', def: 'the abnormal narrowing of the spaces within the spine' },
    { term: 'Radiculopathy', def: 'a pinched nerve — compression of a nerve root in the spine' },
    { term: 'Avascular necrosis, osteonecrosis', def: 'the death of bone tissue caused by insufficient blood flow' },
    { term: 'Osteitis', def: 'inflammation of a bone' },
    { term: 'Osteomalacia', def: 'adult rickets — abnormal softening caused by a vitamin D deficiency' },
    { term: 'Osteomyelitis', def: 'inflammation of the bone marrow and the adjacent bone' },
    { term: 'Periostitis', def: 'inflammation of the outer covering of a bone, often associated with shin splints' },
    { term: 'Paget\'s disease', def: 'a chronic bone disease of unknown cause in which bone is replaced with disorganized fibrous tissue' },
    { term: 'Rickets', def: 'defective bone growth in children caused by a vitamin D deficiency' },
    { term: 'Multiple myeloma', def: 'a cancer of the plasma cells of the red bone marrow' },
    { term: 'Osteochondroma', def: 'a benign bony projection covered with cartilage' },
    { term: 'Osteoporosis', def: 'a marked loss of bone density with increased porosity, frequently associated with aging' },
    { term: 'Osteopenia', def: 'thinner-than-average bone density in someone who does not yet have the fuller condition' },
    { term: 'Colles fracture', def: 'a broken wrist, often from trying to stop a fall by landing on the hand' },
    { term: 'Comminuted fracture', def: 'one in which the bone is splintered or crushed into small pieces' },
    { term: 'Compression fracture', def: 'one in which the bone is pressed together on itself' },
    { term: 'Greenstick fracture', def: 'an incomplete break with one side broken and the other only bent' },
    { term: 'Oblique fracture', def: 'one occurring at an angle across the bone' },
    { term: 'Pathologic fracture', def: 'one in which a bone weakened by disease breaks under normal strain' },
    { term: 'Spiral fracture', def: 'a complete break in which the bone has been twisted apart' },
    { term: 'Stress fracture', def: 'a small crack caused by chronic, excessive impact' },
    { term: 'Transverse fracture', def: 'one occurring straight across, perpendicular to the shaft' },
    { term: 'Crepitation, crepitus', def: 'the grating sound heard when the ends of a broken bone move together' },
    { term: 'Callus', def: 'the bulging deposit forming around a break as the bone heals' },
    { term: 'Fat embolus', def: 'fat cells from yellow marrow released into the bloodstream after a fracture' },
    { fact: true, term: 'The three abnormal curvatures of the spine', def: 'kyphosis, lordosis and scoliosis' },
    { fact: true, term: 'Dislocation versus subluxation', def: 'dislocation is total displacement from the joint, subluxation is partial' },
    { fact: true, term: 'Osteoporosis versus osteopenia', def: 'the first is marked loss of bone density, the second is thinner-than-average density that has not yet reached that point' }
  ],
  questions: [
    { q: 'An abnormal sideways curvature of the spine is:',
      choices: ['Scoliosis', 'Kyphosis', 'Lordosis', 'Spondylosis'], answer: 0,
      why: 'Kyphosis curves outward at the top, lordosis forward at the bottom. Spondylosis is arthritis of the spine, not a curvature at all.' },
    { q: 'Which condition is a chronic autoimmune disorder?',
      choices: ['Rheumatoid arthritis', 'Osteoarthritis', 'Gout', 'Pseudogout'], answer: 0,
      why: 'Osteoarthritis is wear and tear; gout and pseudogout are crystal deposits. Only one has the body attacking itself.' },
    { q: 'A fracture in which the bone is splintered or crushed into small pieces is:',
      choices: ['Comminuted', 'Compression', 'Spiral', 'Oblique'], answer: 0,
      why: 'Compression is pressed together, spiral is twisted apart, oblique is angled. All four describe the shape of the break.' },
    { q: 'Osteomalacia in an adult is caused by a deficiency of:',
      choices: ['Vitamin D', 'Calcium alone', 'Vitamin C', 'Estrogen'], answer: 0,
      why: 'The same deficiency in a child is rickets. Estrogen loss after menopause drives osteoporosis, which is a different mechanism.' },
    { q: 'Blood within a joint is called:',
      choices: ['Hemarthrosis', 'Hemophilia', 'Synovitis', 'Bursitis'], answer: 0,
      why: 'hem (blood) + arthr (joint) + -osis. Building the term from its parts beats memorising it whole.' }
  ]
},
{
  id: 'mt3-procedures',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 3 — Specialists, Diagnostics & Treatment',
  source: 'Chapter 3 — course notes',
  cards: [
    { term: 'Chiropractor', def: 'a specialist in the manipulative treatment of disorders originating from misalignment of the spine' },
    { term: 'Orthopedic surgeon, orthopedist', def: 'a physician who diagnoses and treats diseases of the bones, joints and muscles' },
    { term: 'Osteopath', def: 'a physician providing traditional medical treatment plus spinal manipulation' },
    { term: 'Podiatrist', def: 'a specialist who diagnoses and treats disorders of the foot' },
    { term: 'Rheumatologist', def: 'a specialist in arthritis and disorders marked by inflammation of the joints and connective tissues' },
    { term: 'Arthroscopy', def: 'visual examination of the interior of a joint through a lighted instrument' },
    { term: 'Bone marrow aspiration', def: 'the use of a syringe to withdraw tissue from the red variety of marrow' },
    { term: 'Bone density testing', def: 'measuring the amount of mineral present, to detect losses or changes' },
    { term: 'Dual x-ray absorptiometry', def: 'a low-exposure radiographic measurement of the spine and hips, more accurate than the ultrasonic screening test' },
    { term: 'Ultrasonic bone density testing', def: 'a screening test using sound waves, most often measured at the heel' },
    { term: 'Bisphosphonates', def: 'drugs that slow the loss of bone density, reducing the risk of breaks' },
    { term: 'Bone marrow transplant', def: 'a stem cell transplant used to treat cancers such as leukemia and lymphoma' },
    { term: 'Allogenic', def: 'taken from a compatible donor, often a sibling' },
    { term: 'Autologous', def: 'taken from the patient\'s own body, harvested and stored beforehand' },
    { term: 'Orthotic', def: 'a mechanical appliance such as a shoe insert, brace or splint that supports or corrects impaired limb function' },
    { term: 'Prosthesis', def: 'a substitute for a diseased or missing body part' },
    { term: 'Arthrodesis', def: 'the surgical fusion of two bones to stiffen a joint' },
    { term: 'Arthroplasty', def: 'the surgical repair of a damaged joint, usually resurfacing or placing an implant' },
    { term: 'Synovectomy', def: 'the surgical removal of the membrane lining a joint' },
    { term: 'Bone grafting', def: 'transplanting tissue to rebuild damaged bone' },
    { term: 'Allograft', def: 'a graft in which the tissue comes from a donor or cadaver' },
    { term: 'Autograft', def: 'a graft in which the tissue comes from the patient' },
    { term: 'Laminectomy', def: 'the surgical removal of the posterior portion of a vertebra to relieve pressure on the spinal cord' },
    { term: 'Percutaneous vertebroplasty', def: 'the injection of bone cement to stabilise a compression fracture' },
    { term: 'Percutaneous diskectomy', def: 'the removal of the disk fragment compressing a nerve' },
    { term: 'Spinal fusion', def: 'immobilising part of the spine by joining two or more vertebrae' },
    { term: 'Craniectomy', def: 'the surgical removal of a portion of the skull to relieve intracranial pressure' },
    { term: 'Craniotomy', def: 'a surgical incision into the skull, performed to reach the brain' },
    { term: 'Osteotomy', def: 'the surgical cutting and reshaping of a bone' },
    { term: 'Closed reduction, manipulation', def: 'the attempted non-surgical realignment of a fracture or dislocation' },
    { term: 'Open reduction', def: 'the surgical realignment of a fracture, when the non-surgical route is impractical' },
    { term: 'Traction', def: 'a pulling force exerted on a limb to return a bone or joint to normal alignment' },
    { term: 'External fixation', def: 'fracture treatment using an appliance outside the body, removed once healed' },
    { term: 'Internal fixation', def: 'plates or pins placed directly into the bone, and not usually removed afterwards' },
    { term: 'Phantom limb pain', def: 'the post-amputation sensation of pain from a body part that is no longer there' },
    { fact: true, term: 'Allogenic versus autologous', def: 'allogenic marrow comes from a compatible donor, autologous from the patient' },
    { fact: true, term: 'The two bone density tests', def: 'ultrasonic screening at the heel, and dual x-ray absorptiometry of the spine and hips' },
    { fact: true, term: 'Which fixation stays in the body', def: 'internal — the external kind is removed once the bone has healed' }
  ],
  questions: [
    { q: 'Which specialist treats disorders of the foot?',
      choices: ['Podiatrist', 'Orthopedist', 'Chiropractor', 'Rheumatologist'], answer: 0,
      why: 'The orthopedist covers bones and joints generally. Narrow the scope: this one is the foot alone.' },
    { q: 'A bone graft using tissue from the patient is an:',
      choices: ['Autograft', 'Allograft', 'Autolysis', 'Allogenic transplant'], answer: 0,
      why: 'auto- means self, allo- means other. The same prefix pair separates autologous from allogenic marrow.' },
    { q: 'Laminectomy removes which structure?',
      choices: ['The posterior portion of a vertebra', 'An intervertebral disk',
        'A synovial membrane', 'A portion of the skull'], answer: 0,
      why: 'lamin (lamina) + -ectomy (surgical removal). Removing the lamina enlarges the spinal column and relieves pressure on the cord.' },
    { q: 'Which fracture treatment is NOT usually removed after healing?',
      choices: ['Internal fixation', 'External fixation', 'Traction', 'Closed reduction'], answer: 0,
      why: 'Plates and pins placed into the bone stay put. External appliances come off, and the other two are not implants at all.' }
  ]
},
{
  id: 'mt4-parts',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 4 — Muscular: Word Parts',
  source: 'Chapter 4 — course notes',
  cards: [
    { term: 'bi-', def: 'two' },
    { term: 'tri-', def: 'three' },
    { term: 'dys-', def: 'bad, difficult or painful' },
    { term: 'clon/o', def: 'violent action' },
    { term: 'fasci/o', def: 'the fibrous band that covers, supports and separates muscles' },
    { term: 'fibr/o', def: 'fibrous tissue' },
    { term: 'kines/o, kinesi/o', def: 'movement' },
    { term: 'my/o', def: 'muscle' },
    { term: 'muscul/o, myos/o', def: 'muscle' },
    { term: 'tax/o', def: 'coordination or order' },
    { term: 'ten/o, tend/o, tendin/o', def: 'the band of tissue attaching a muscle to a bone' },
    { term: 'ton/o', def: 'tone or tension' },
    { term: '-ia', def: 'condition' },
    { term: '-ic', def: 'pertaining to' },
    { term: '-lysis', def: 'breakdown, or setting free' },
    { term: '-plegia', def: 'paralysis' },
    { term: '-paresis', def: 'partial or incomplete paralysis' },
    { term: '-rrhaphy', def: 'surgical suturing' },
    { term: '-asthenia', def: 'weakness or lack of strength' },
    { fact: true, term: 'The three roots that all mean muscle', def: 'my/o, muscul/o and myos/o' },
    { fact: true, term: 'The degree prefixes used across this chapter', def: 'a- without, dys- bad, hypo- deficient, hyper- excessive, brady- slow' },
    { fact: true, term: 'The number prefixes used across this chapter', def: 'bi- two, tri- three, quadr/i- four, hemi- half' },
    { fact: true, term: 'The two roots most often confused', def: 'my/o is muscle, myel/o is bone marrow or spinal cord',
      note: 'A myoma is a muscle tumour; a myeloma is a marrow tumour. One letter apart, different systems.' }
  ],
  questions: [
    { q: 'Bradykinesia breaks down into which parts?',
      choices: ['brady- (slow) + kines (movement) + -ia (condition)',
        'brady- (bad) + kines (movement) + -ia (condition)',
        'brady- (slow) + kines (muscle) + -ia (condition)',
        'brady- (slow) + kines (movement) + -ia (pertaining to)'], answer: 0,
      why: 'Swap the prefix and the same root gives dyskinesia (jerky) or hyperkinesia (increased). One root, three conditions.' },
    { q: 'Which suffix means paralysis?',
      choices: ['-plegia', '-paresis', '-lysis', '-asthenia'], answer: 0,
      why: '-paresis is the weaker cousin, meaning partial paralysis. Hemiplegia is total on one side; hemiparesis is weakness on one side.' },
    { q: 'Tenolysis means:',
      choices: ['The release of a tendon from adhesions', 'The surgical cutting of a tendon',
        'The suturing of a tendon to a bone', 'Inflammation of a tendon sheath'], answer: 0,
      why: '-lysis means setting free. Compare tenotomy (cutting), tenodesis (binding) and tenosynovitis (inflammation) — same root, four different suffixes.' },
    { q: 'A patient described as atonic is lacking:',
      choices: ['Normal muscle tone', 'Coordination', 'Any movement at all', 'Muscle mass'], answer: 0,
      why: 'a- (without) + ton (tone) + -ic. Lack of coordination would be ataxia, from tax/o.' }
  ]
},
{
  id: 'mt4-structure',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 4 — Muscle Structure & Function',
  source: 'Chapter 4 — course notes',
  cards: [
    { term: 'Musculoskeletal system', def: 'the muscular and skeletal systems working jointly to provide form, support, stability and movement' },
    { term: 'Muscle fibers', def: 'the long, slender cells that make up a muscle' },
    { term: 'Fascia', def: 'the band of connective tissue that envelops, separates or binds muscles' },
    { term: 'Myofascial', def: 'pertaining to muscle tissue and its surrounding fibrous band' },
    { term: 'Tendons', def: 'narrow bands of nonelastic, dense, fibrous tissue attaching muscle to bone' },
    { term: 'Aponeurosis', def: 'sheet-like fibrous tissue resembling a flattened tendon, connecting muscles to each other or to bone' },
    { term: 'Achilles tendon', def: 'the band attaching the gastrocnemius to the heel bone' },
    { term: 'Skeletal muscle', def: 'the voluntary, striated type attached to bones, which makes body motions possible' },
    { term: 'Smooth muscle, visceral muscle', def: 'the involuntary, unstriated type found in the walls of the internal organs' },
    { term: 'Myocardial muscle', def: 'the heart wall type — striated in appearance but involuntary in control' },
    { term: 'Muscle innervation', def: 'the stimulation of a muscle by an impulse carried along a motor nerve' },
    { term: 'Neuromuscular', def: 'pertaining to the relationship between a nerve and a muscle' },
    { term: 'Antagonistic muscle pairs', def: 'muscles arranged so that when one contracts, the other relaxes' },
    { term: 'Contraction', def: 'the tightening of a muscle' },
    { term: 'Relaxation', def: 'a muscle returning to its original form' },
    { term: 'Origin', def: 'the place where a muscle begins — the less movable attachment, nearest the midline' },
    { term: 'Insertion', def: 'the place where a muscle ends — the more movable attachment, farthest from the midline' },
    { term: 'Rotator cuff', def: 'the group of muscles and tendons holding the head of the humerus securely in place' },
    { term: 'Oblique', def: 'describing muscle fibers that run slanted or at an angle' },
    { term: 'Rectus', def: 'describing muscle fibers that run straight, aligned with the vertical axis' },
    { term: 'Transverse', def: 'describing muscle fibers that run crosswise' },
    { term: 'Sphincter', def: 'a ring-like muscle that tightly constricts the opening of a passageway' },
    { term: 'Masseter', def: 'one of the strongest muscles in the body, which closes the jaw when chewing' },
    { term: 'Deltoid', def: 'the muscle forming the cap of the shoulder, shaped like an inverted triangle' },
    { term: 'Biceps brachii', def: 'the anterior upper arm muscle that flexes the elbow' },
    { term: 'Triceps brachii', def: 'the posterior upper arm muscle that extends the elbow' },
    { term: 'Gastrocnemius', def: 'the calf muscle, which flexes the knee and bends the foot downward' },
    { term: 'Hamstring group', def: 'the muscles responsible for knee flexion and hip extension' },
    { fact: true, term: 'The three types of muscle tissue', def: 'skeletal, smooth and myocardial' },
    { fact: true, term: 'Which muscle type is striated but involuntary', def: 'myocardial — it looks like skeletal muscle but behaves like smooth' },
    { fact: true, term: 'Tendons versus ligaments', def: 'tendons attach muscle to bone, ligaments join bone to bone' },
    { fact: true, term: 'What percentage of body weight is muscle', def: 'about 40 to 45%, across more than 600 muscles' },
    { fact: true, term: 'How muscles get their names', def: 'origin and insertion, action, location, fiber direction, number of divisions, and size or shape' }
  ],
  questions: [
    { q: 'Which muscle type is striated in appearance but involuntary in control?',
      choices: ['Myocardial', 'Skeletal', 'Smooth', 'Visceral'], answer: 0,
      why: 'Skeletal is striated and voluntary; smooth (also called visceral) is unstriated and involuntary. The heart borrows one trait from each.' },
    { q: 'Tendons attach muscle to bone. What joins bone to bone?',
      choices: ['Ligaments', 'Fascia', 'Aponeurosis', 'Cartilage'], answer: 0,
      why: 'This pair gets tested constantly, and the sprain/strain distinction depends on it — a sprain is a torn ligament, a strain a torn muscle or tendon.' },
    { q: 'The more movable attachment of a muscle, farthest from the midline, is the:',
      choices: ['Insertion', 'Origin', 'Aponeurosis', 'Fascia'], answer: 0,
      why: 'The origin is the anchor: nearer the midline and less movable. Muscles like the sternocleidomastoid are named for both.' },
    { q: 'A muscle named rectus has fibers running:',
      choices: ['Straight, along the vertical axis', 'At a slant', 'Crosswise', 'In a ring'], answer: 0,
      why: 'Oblique is slanted, transverse is crosswise, sphincter is ring-like. All four naming words appear in real muscle names in this chapter.' }
  ]
},
{
  id: 'mt4-motions',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 4 — Muscle Motions',
  source: 'Chapter 4 — course notes',
  cards: [
    { term: 'Abduction', def: 'movement of a limb away from the midline of the body' },
    { term: 'Adduction', def: 'movement of a limb toward the midline of the body' },
    { term: 'Flexion', def: 'decreasing the angle between two bones — bending a limb at a joint' },
    { term: 'Extension', def: 'increasing the angle between two bones — straightening a limb' },
    { term: 'Hyperextension', def: 'the overextension of a limb beyond its normal limit' },
    { term: 'Elevation', def: 'raising or lifting a body part' },
    { term: 'Depression', def: 'lowering a body part' },
    { term: 'Rotation', def: 'circular movement around an axis, turning a bone on its own axis' },
    { term: 'Circumduction', def: 'circular movement at the far end of a limb' },
    { term: 'Supination', def: 'rotating so the palm or sole faces forward or upward' },
    { term: 'Pronation', def: 'rotating so the palm or sole faces downward or backward' },
    { term: 'Dorsiflexion', def: 'bending the foot upward at the ankle' },
    { term: 'Plantar flexion', def: 'bending the foot downward at the ankle' },
    { term: 'Levator', def: 'a muscle that raises a body part' },
    { term: 'Depressor', def: 'a muscle that lowers a body part' },
    { term: 'Abductor', def: 'a muscle that moves a part away from the midline' },
    { term: 'Adductor', def: 'a muscle that moves a part toward the midline' },
    { term: 'Axis', def: 'the imaginary line running lengthwise through the centre of the body' },
    { fact: true, term: 'The four opposing motion pairs', def: 'abduction and adduction, flexion and extension, elevation and depression, supination and pronation' },
    { fact: true, term: 'A memory aid for supination', def: 'the palm turns up, as though carrying a bowl of soup' },
    { fact: true, term: 'The two ankle motions', def: 'dorsiflexion bends the foot upward, plantar flexion bends it downward' },
    { fact: true, term: 'Rotation versus circumduction', def: 'rotation turns a bone on its own axis, circumduction makes a circle at the far end of a limb' }
  ],
  questions: [
    { q: 'Movement of a limb away from the midline of the body is:',
      choices: ['Abduction', 'Adduction', 'Circumduction', 'Rotation'], answer: 0,
      why: 'Abduct means to take away, which is the same sense as the everyday word. Adduction adds the limb back toward the body.' },
    { q: 'Bending the foot downward at the ankle is:',
      choices: ['Plantar flexion', 'Dorsiflexion', 'Pronation', 'Supination'], answer: 0,
      why: 'Plantar refers to the sole of the foot, so plantar flexion points the sole downward. Dorsiflexion is the opposite.' },
    { q: 'Which motion increases the angle between two bones?',
      choices: ['Extension', 'Flexion', 'Rotation', 'Elevation'], answer: 0,
      why: 'Straightening a limb opens the angle. Going past the normal limit is hyperextension, which is a third option on this same axis.' },
    { q: 'Rotating the forearm so the palm faces upward is:',
      choices: ['Supination', 'Pronation', 'Circumduction', 'Adduction'], answer: 0,
      why: 'Pronation is the reverse, palm down. The pair applies to the sole of the foot as well as to the hand.' }
  ]
},
{
  id: 'mt4-pathology',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 4 — Muscular Pathology',
  source: 'Chapter 4 — course notes',
  cards: [
    { term: 'Fasciitis', def: 'inflammation of the fibrous band covering a muscle' },
    { term: 'Plantar fasciitis', def: 'inflammation of that band on the sole of the foot' },
    { term: 'Fibromyalgia', def: 'a debilitating chronic condition of fatigue with diffuse or specific muscle, joint or bone pain' },
    { term: 'Tenosynovitis', def: 'inflammation of the sheath surrounding a tendon' },
    { term: 'Tendinitis', def: 'the acute inflammation or irritation of tendons from excessive or unusual use of a joint' },
    { term: 'Tendinosis', def: 'a chronic painful condition caused by repetitive overuse or an injury that has not healed' },
    { term: 'Tendinopathy', def: 'the irritation or degeneration of a tendon in any joint' },
    { term: 'Chronic fatigue syndrome', def: 'a debilitating, complex disorder of unknown cause affecting many body systems' },
    { term: 'Adhesion', def: 'a band of fibrous tissue holding structures together abnormally, often after injury or surgery' },
    { term: 'Atrophy', def: 'the weakness or wearing away of tissue, from disease or from long disuse' },
    { term: 'Cachexia', def: 'physically wasting away from loss of weight and muscle mass, seen in advanced cancer or AIDS' },
    { term: 'Hernia', def: 'tissue protruding through a weak area in the muscle that normally contains it' },
    { term: 'Myalgia', def: 'tenderness or pain in the muscles' },
    { term: 'Polymyositis', def: 'the simultaneous inflammation and weakening of voluntary muscles in many parts of the body' },
    { term: 'Rhabdomyolysis', def: 'the breakdown of striated fibers, which release their contents into the blood and can cause renal failure' },
    { term: 'Sarcopenia', def: 'the loss of muscle mass, strength and function that comes with aging' },
    { term: 'Atonic', def: 'lacking normal tone or strength' },
    { term: 'Dystonia', def: 'a movement disorder of involuntary, sometimes repetitive contraction of certain muscles' },
    { term: 'Hypotonia', def: 'diminished tone of the skeletal muscles, called floppy baby syndrome in infants' },
    { term: 'Ataxia', def: 'the lack of coordination during voluntary movement, producing shaky, unsteady motion' },
    { term: 'Contracture', def: 'the permanent tightening of fascia, muscle, tendon, ligament or skin' },
    { term: 'Intermittent claudication', def: 'leg pain from poor circulation, occurring during exercise and relieved by rest' },
    { term: 'Spasm', def: 'a sudden, involuntary contraction' },
    { term: 'Tic', def: 'a repeated spasm, often of the eyelids or face' },
    { term: 'Myoclonus', def: 'the quick, involuntary jerking of a muscle or group, which may occur normally as a person falls asleep' },
    { term: 'Singultus', def: 'hiccups — a jerking spasm of the diaphragm' },
    { term: 'Cramp', def: 'a painful localised spasm, often named for its cause' },
    { term: 'Torticollis, wryneck', def: 'a stiff neck from spasmodic contraction, pulling the head toward the affected side' },
    { term: 'Bradykinesia', def: 'extreme slowness of movement' },
    { term: 'Dyskinesia', def: 'fragmented or jerky motions' },
    { term: 'Hyperkinesia', def: 'abnormally increased muscle function or activity' },
    { term: 'Myasthenia gravis', def: 'a chronic autoimmune disease affecting the junction between nerve and muscle' },
    { term: 'Muscular dystrophy', def: 'a general term for more than 30 genetic diseases causing progressive weakness and degeneration of skeletal muscle' },
    { term: 'Compartment syndrome', def: 'compression of nerves and blood vessels from swelling within the space separating muscle groups' },
    { term: 'Trigger finger', def: 'painful, progressive restriction of movement from inflammation of a tendon sheath' },
    { term: 'Myofascial pain syndrome', def: 'chronic pain of muscles and fascia, with trigger points producing local and referred pain' },
    { term: 'Carpal tunnel syndrome', def: 'swollen tendons in the wrist pressing on the median nerve' },
    { term: 'Ganglion cyst', def: 'a benign, fluid-filled lump, usually on the outer wrist or hand' },
    { term: 'Epicondylitis', def: 'inflammation of the tissues surrounding the elbow — tennis elbow laterally, golfer\'s elbow medially' },
    { term: 'Impingement syndrome', also: ['tennis shoulder', "swimmer's shoulder"], def: 'rotator cuff tendinitis, also called tennis shoulder or swimmer\'s shoulder' },
    { term: 'Heel spur', def: 'a calcium deposit in the plantar fascia' },
    { term: 'Morton\'s neuroma', def: 'pain on the ball of the foot from a swollen, inflamed nerve' },
    { term: 'Shin splint', def: 'pain caused by the tibialis anterior tearing away from the shin bone' },
    { term: 'Sprain', def: 'a wrenched or torn ligament' },
    { term: 'Strain', def: 'a stretched or torn muscle or tendon attachment' },
    { term: 'Iliotibial band syndrome', def: 'a fibrous band rubbing against bone, often near the knee' },
    { term: 'Paralysis', def: 'the loss of sensation and voluntary muscle movement' },
    { term: 'Myoparesis', def: 'weakness or slight muscular paralysis' },
    { term: 'Hemiparesis', def: 'weakness or slight paralysis affecting one side of the body, a common effect of a stroke' },
    { term: 'Hemiplegia', def: 'total paralysis affecting one side of the body' },
    { term: 'Paraplegia', def: 'paralysis of both legs and the lower part of the body' },
    { term: 'Quadriplegia, tetraplegia', def: 'paralysis of all four extremities' },
    { fact: true, term: 'The five types of paralysis in this chapter', def: 'myoparesis, hemiparesis, hemiplegia, paraplegia and quadriplegia' },
    { fact: true, term: 'Sprain versus strain', def: 'a sprain tears a ligament, a strain tears a muscle or tendon attachment' },
    { fact: true, term: 'Tendinitis versus tendinosis', def: 'tendinitis is acute inflammation, tendinosis is a chronic unhealed condition' },
    { fact: true, term: 'Incomplete versus complete spinal cord injury', def: 'some function remains below the injury in an incomplete one; a complete one means total loss of sensation and muscle control below it' },
    { fact: true, term: 'The two most common forms of muscular dystrophy', def: 'Duchenne and Becker' }
  ],
  questions: [
    { q: 'Which term describes paralysis of all four extremities?',
      choices: ['Quadriplegia', 'Paraplegia', 'Hemiplegia', 'Hemiparesis'], answer: 0,
      why: 'quadr/i means four. Paraplegia is the legs and lower body, hemiplegia one side — the number prefix does all the work.' },
    { q: 'A stretched or torn muscle is a:',
      choices: ['Strain', 'Sprain', 'Spasm', 'Contracture'], answer: 0,
      why: 'A sprain involves a ligament instead. This pair is a favourite because the words sound so similar.' },
    { q: 'Hiccups are technically which condition?',
      choices: ['Singultus', 'Myoclonus of the calf', 'A tic', 'A cramp'], answer: 0,
      why: 'Singultus is a jerking spasm of the diaphragm — a specific case of myoclonus, which is the general term.' },
    { q: 'Carpal tunnel syndrome puts pressure on which nerve?',
      choices: ['Median', 'Ulnar', 'Radial', 'Sciatic'], answer: 0,
      why: 'Swollen tendons in the wrist compress it. The carpal tunnel itself is formed by the eight carpal bones from Chapter 3.' },
    { q: 'Which condition is an autoimmune disease of the neuromuscular junction?',
      choices: ['Myasthenia gravis', 'Muscular dystrophy', 'Fibromyalgia', 'Polymyositis'], answer: 0,
      why: 'Muscular dystrophy is genetic, fibromyalgia is a chronic pain condition. my + -asthenia literally means muscle weakness.' },
    { q: 'Leg pain from poor circulation that appears during exercise and eases with rest is:',
      choices: ['Intermittent claudication', 'A cramp', 'Contracture', 'Shin splint'], answer: 0,
      why: 'Claudication means limping, and intermittent means coming and going. The exercise-then-rest pattern is the giveaway.' }
  ]
},
{
  id: 'mt4-procedures',
  ...
  added: '2026-08-19',
  course: 'M159 · Medical Terminology 1',
  title: 'Ch. 4 — Specialists, Diagnostics & Treatment',
  source: 'Chapter 4 — course notes',
  cards: [
    { term: 'Exercise physiologist', def: 'a specialist who develops and coordinates exercise programs and administers medical tests under a physician\'s supervision' },
    { term: 'Neurologist', def: 'a physician who treats the causes of paralysis and similar disorders involving loss of function' },
    { term: 'Occupational therapist', def: 'a specialist who helps patients take part in daily activities such as self-care, education and work' },
    { term: 'Physiatrist', def: 'a physician specialising in physical medicine and rehabilitation, focused on restoring function' },
    { term: 'Physical therapist', def: 'a specialist who prevents disability or restores function through exercise, heat, massage and similar techniques' },
    { term: 'Sports medicine physician', def: 'a specialist in preventing and treating injuries of the bones, joints and muscles in active people' },
    { term: 'Deep tendon reflexes', def: 'the involuntary response tested by striking a tendon with a hammer, as in the knee-jerk test' },
    { term: 'Range-of-motion testing', def: 'evaluation of joint mobility and muscle strength' },
    { term: 'Electromyography', def: 'a procedure measuring the electrical activity within muscle fibers in response to nerve stimulation' },
    { term: 'Muscle biopsy', def: 'the removal of a plug of tissue for examination' },
    { term: 'Antispasmodic, anticholinergic', def: 'a drug suppressing smooth muscle contractions of the stomach, intestine or bladder' },
    { term: 'Corticosteroid, cortisone', def: 'a drug relieving pain and inflammation in a specific joint' },
    { term: 'Anabolic steroids', def: 'drugs that replace muscle loss, sometimes used illegally by athletes to build mass' },
    { term: 'Muscle relaxant', def: 'a drug acting on the central nervous system to relieve stiffness and pain' },
    { term: 'Neuromuscular-blocking drugs', def: 'agents causing temporary paralysis by blocking nerve stimuli, used with anesthesia during surgery' },
    { term: 'Platelet-rich plasma therapy', def: 'the patient\'s own blood is concentrated and injected into a joint to promote healing' },
    { term: 'Viscosupplementation', def: 'injections of hyaluronic acid into the knee to increase the joint\'s lubricating fluid' },
    { term: 'Ergonomics', def: 'the study of the human factors affecting the design and operation of tools and the work environment' },
    { term: 'Myofascial release', def: 'a soft-tissue manipulation technique used to ease pain' },
    { term: 'Occupational therapy', def: 'rehabilitation helping patients perform the activities of daily living' },
    { term: 'Physical therapy', def: 'treatment to prevent disability or restore function through exercise, heat and massage' },
    { term: 'Therapeutic ultrasound', def: 'high-frequency sound waves generating deep heat to ease pain, reduce spasm and speed healing' },
    { term: 'Transcutaneous electrical nerve stimulation', def: 'a device delivering electrical impulses through the skin to cause changes in muscles' },
    { term: 'RICE', def: 'rest, ice, compression and elevation — the most common first aid for soft tissue injuries' },
    { term: 'Carpal tunnel release', def: 'surgery to reduce the pressure on the median nerve at the wrist' },
    { term: 'Fasciotomy', def: 'a surgical incision through the fibrous band covering a muscle, to relieve tension or pressure' },
    { term: 'Tenodesis', def: 'the surgical suturing of the end of a tendon to a bone' },
    { term: 'Tenolysis', def: 'the release of a tendon from adhesions' },
    { term: 'Tenotomy', def: 'the surgical cutting of a tendon to release or lengthen it' },
    { term: 'Myorrhaphy', def: 'the surgical suturing of a muscle wound' },
    { term: 'Myotomy', def: 'a surgical incision into a muscle' },
    { fact: true, term: 'The four tendon procedures', def: 'tenodesis binds, tenolysis frees, tenotomy cuts, and tenorrhaphy sutures' },
    { fact: true, term: 'What RICE stands for', def: 'rest, ice, compression, elevation' },
    { fact: true, term: 'Physiatrist versus physical therapist', def: 'the physiatrist is a physician specialising in rehabilitation; the therapist delivers the treatment' }
  ],
  questions: [
    { q: 'Which procedure measures the electrical activity within muscle fibers?',
      choices: ['Electromyography', 'Range-of-motion testing', 'Muscle biopsy', 'Deep tendon reflexes'], answer: 0,
      why: 'electr/o (electricity) + my/o (muscle) + -graphy (process of recording). The name states exactly what it does.' },
    { q: 'Tenodesis is the surgical:',
      choices: ['Suturing of a tendon to a bone', 'Cutting of a tendon',
        'Release of a tendon from adhesions', 'Incision through the fascia'], answer: 0,
      why: '-desis means to bind or tie together, the same suffix as arthrodesis in Chapter 3. The other options are tenotomy, tenolysis and fasciotomy.' },
    { q: 'A physician specialising in physical medicine and rehabilitation is a:',
      choices: ['Physiatrist', 'Physical therapist', 'Exercise physiologist', 'Neurologist'], answer: 0,
      why: 'The physical therapist provides treatment but is not a physician. The similar-sounding names are exactly why this gets asked.' },
    { q: 'RICE, the standard first aid for soft tissue injury, stands for:',
...
},
{
  ...
  source: 'Every prefix taught so far, from all chapters',
  cards: [
    { term: 'ab-', def: 'away from, negative, absent' },
    { term: 'ad-', def: 'toward, to, in the direction of' },
    { term: 'bi-', def: 'two, both sides' },
    { term: 'dextro-', def: 'right side' },
    { term: 'dys-', def: 'bad, difficult, painful or abnormal' },
    { term: 'end-', def: 'in, within, inside' },
    { term: 'endo-', def: 'in, within, inside' },
    { term: 'epi-', def: 'above, over or upon' },
    { term: 'eu-', def: 'good, normal' },
    { term: 'ex-', def: 'out of, outside, away from' },
    { term: 'exo-', def: 'out of, outside, away from' },
    { term: 'hyper-', def: 'excessive or increased' },
    { term: 'hypo-', def: 'below, deficient or decreased' },
    { term: 'in-', def: 'in, into, not, without' },
    { term: 'inter-', def: 'between or among' },
    { term: 'intra-', def: 'within or inside' },
    { term: 'macro-', def: 'large, abnormal size or long' },
    { term: 'mega-', def: 'large, great' },
    { term: 'megalo-', def: 'large, great' },
    { term: 'micro-', def: 'small' },
    { term: 'oligo-', def: 'scanty, few' },
    { term: 'peri-', def: 'around, surrounding' },
    { term: 'post-', def: 'after, behind' },
    ...
    { term: 'sinistro-', def: 'left side' },
    { term: 'sub-', def: 'under, less or below' },
    { term: 'super-', def: 'above or excessive' },
    { term: 'supra-', def: 'above or excessive' },
    { term: 'tri-', def: 'three' }
  ]
},
{
  ...
  added: '2026-08-20',
  course: 'M159 · Medical Terminology 1',
  title: 'Word Parts — Roots',
  source: 'Every combining form taught so far, from all chapters',
  cards: [
    { term: 'abdomin/o', def: 'abdomen' },
    { term: 'aden/o', def: 'gland' },
    { term: 'adip/o', def: 'fat' },
    ...
    { term: 'home/o', def: 'constant' },
    { term: 'ili/o', def: 'hip bone' },
    { term: 'kines/o', def: 'movement' },
    { term: 'kinesi/o', def: 'movement' },
    { term: 'kyph/o', def: 'hump' },
    { term: 'leuk/o', def: 'white' },
    { term: 'ligament/o', def: 'the fibrous band connecting one bone to another' },
    { term: 'lip/o', def: 'fat, lipid' },
    ...
    { term: 'lumb/o', def: 'lower back' },
    { term: 'melan/o', def: 'black, dark' },
    { term: 'muscul/o', def: 'muscle' },
    { term: 'my/o', def: 'muscle' },
    { term: 'myc/o', def: 'fungus' },
    { term: 'myel/o', def: 'bone marrow, and also spinal cord' },
    { term: 'myos/o', def: 'muscle' },
    { term: 'neur/o', def: 'nerve' },
    { term: 'onych/o', def: 'fingernail or toenail' },
    { term: 'oss/e', def: 'bone' },
    { term: 'oss/i', def: 'bone' },
    ...
    { term: 'pil/i', def: 'hair' },
    { term: 'pil/o', def: 'hair' },
    { term: 'plas/i', def: 'development, growth, formation' },
    { term: 'plas/o', def: 'development, growth, formation' },
    { term: 'pneum/o', def: 'air or lung' },
    { term: 'poli/o', def: 'gray' },
    { term: 'poster/o', def: 'behind, toward the back' },
    { term: 'pulmon/o', def: 'lung' },
    ...
    { term: 'seb/o', def: 'sebum, the oily secretion of the skin' },
    { term: 'spondyl/o', def: 'vertebrae' },
    { term: 'synov/o', def: 'the membrane lining a freely movable joint, and the lubricant it secretes' },
    { term: 'synovi/o', def: 'the membrane lining a freely movable joint, and the lubricant it secretes' },
    { term: 'tax/o', def: 'coordination or order' },
    { term: 'ten/o', def: 'tendon' },
    { term: 'tend/o', def: 'the band of tissue attaching a muscle to a bone' },
    { term: 'tendin/o', def: 'the band of tissue attaching a muscle to a bone' },
    { term: 'thorac/o', def: 'chest' },
    { term: 'ton/o', def: 'tone or tension' },
    { term: 'tonsill/o', def: 'tonsils' },
    { term: 'ungu/o', def: 'nail' },
...
},
{
  ...
  source: 'Every suffix taught so far, from all chapters',
  cards: [
    { term: '-a', def: 'noun endings (turn the root into a noun)' },
    { term: '-ac', def: 'pertaining to (adjectival suffixes)' },
    { term: '-al', def: 'pertaining to (adjectival suffixes)' },
    { term: '-algia', def: 'pain / suffering' },
    { term: '-ar', def: 'pertaining to (adjectival suffixes)' },
    { term: '-ary', def: 'pertaining to (adjectival suffixes)' },
    { term: '-asthenia', def: 'weakness or lack of strength' },
    { term: '-centesis', def: 'surgical puncture to remove fluid' },
    { term: '-cyte', def: 'cell' },
    { term: '-desis', def: 'to bind or tie together' },
    { term: '-dynia', def: 'pain (second form)' },
    { term: '-e', def: 'noun endings (turn the root into a noun)' },
    { term: '-eal', def: 'pertaining to (as in retroperitoneal)' },
    { term: '-ectomy', def: 'surgical removal' },
    { term: '-gram', def: 'picture or record' },
    { term: '-graph', def: 'instrument used to record' },
    ...
    { term: '-ostomy', def: 'create an artificial opening' },
    { term: '-otomy', def: 'cut or make a surgical incision' },
    { term: '-ous', def: 'pertaining to (adjectival suffixes)' },
    { term: '-paresis', def: 'partial or incomplete paralysis' },
    { term: '-pathy', def: 'disease, suffering, feeling, emotion' },
    { term: '-plasia', def: 'development, growth, formation' },
    { term: '-plasm', def: 'formative material of cells' },
    ...
    { term: '-sclerosis', def: 'abnormal hardening' },
    { term: '-scopy', def: 'visual examination' },
    { term: '-stasis', def: 'control, maintenance of a constant level' },
    { term: '-static', def: 'control, maintenance of a constant level' },
    { term: '-stenosis', def: 'abnormal narrowing' },
    { term: '-tics', def: 'pertaining to (as in genetics)' },
    { term: '-um', def: 'noun endings (turn the root into a noun)' },
    { term: '-us', def: 'noun endings (turn the root into a noun)' },
    { term: '-y', def: 'noun endings (turn the root into a noun)' }
  ]
},
];
