...
},
{
  ...
  labels: [{
    ...
    items: [
      ...
      { id: 'Inferior orbital fissure', name: 'Inferior orbital fissure', x: 69, y: 53.5, lead: true, group: 'Openings and fissures', about: 'the slit along the posterolateral floor of the orbit' },
