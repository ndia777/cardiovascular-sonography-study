...
},
{
  ...
  label: {
    ...
    items: [
      ...
      { id: 'Temporal bone', name: 'Temporal bone', x: 45.9, y: 53.9, to: [10, 29.1], about: 'the lower side wall of the cranium; it houses the middle and inner ear' },
      ...
      { id: 'Ethmoid bone', name: 'Ethmoid bone', x: 69.6, y: 45.8, to: [90, 14.2], about: 'a light bone in the medial wall of the orbit and the roof of the nasal cavity' },
      { id: 'Lacrimal bone', name: 'Lacrimal bone', x: 71.4, y: 47.4, to: [90, 44.9], about: 'the smallest facial bone, in the medial wall of the orbit' },
      { id: 'Nasal bone', name: 'Nasal bone', x: 77.3, y: 45.8, to: [90, 24.4], about: 'the small paired bones forming the bridge of the nose' },
      ...
      { id: 'Mandible', name: 'Mandible', x: 64.4, y: 79.8, to: [90, 85.8], about: 'the lower jaw, the only freely movable bone of the skull' },
      { id: 'Coronal suture', name: 'Coronal suture', x: 54.1, y: 17.7, to: [10, 4], about: 'the immovable joint between the frontal bone and the two parietal bones' },
      { id: 'Squamous suture', name: 'Squamous suture', x: 50, y: 37.3, to: [10, 20.7], about: 'the joint along the upper edge of the temporal bone, where it meets the parietal' },
      { id: 'Lambdoid suture', name: 'Lambdoid suture', x: 20.2, y: 53.6, to: [10, 37.5], about: 'the joint between the occipital bone and the parietal bones' },
      { id: 'External acoustic meatus', name: 'External acoustic meatus', x: 46.1, y: 61.9, to: [10, 62.5], about: 'the opening in the temporal bone that leads to the middle ear' },
      { id: 'Mastoid process', name: 'Mastoid process', x: 47.8, y: 72.1, to: [10, 96], about: 'the blunt projection of the temporal bone behind the ear' },
      { id: 'Styloid process', name: 'Styloid process', x: 50, y: 71.2, to: [10, 87.6], about: 'the slender spike below the ear, an attachment for tongue and pharynx muscles' },
      { id: 'Zygomatic process of temporal bone', name: 'Zygomatic process of temporal bone', x: 53.3, y: 57.2, to: [10, 45.8], about: 'the rearward half of the zygomatic arch, projecting forward from the temporal bone' },
      { id: 'Temporal process of zygomatic bone', name: 'Temporal process of zygomatic bone', x: 61.4, y: 56.5, to: [90, 65.3], about: 'the forward half of the zygomatic arch, projecting back from the cheekbone' },
      { id: 'Mandibular condyle', name: 'Mandibular condyle', x: 49.7, y: 61.4, to: [10, 54.2], about: 'the rounded head of the mandible, which articulates with the temporal bone' },
      { id: 'Coronoid process', name: 'Coronoid process', x: 60, y: 65.7, to: [10, 79.3], about: 'the pointed projection on the front of the mandible ramus, for the temporalis muscle' },
      { id: 'Mental foramen', name: 'Mental foramen', x: 75.7, y: 87.8, to: [90, 96], about: 'the small opening on the front of the mandible for nerves and vessels to the chin' },
    ],
  },
  region: {
    name: 'skullLateral',
