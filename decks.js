...
},
{
  ...
  labels: [{
    ...
    items: [
      { id: 'Cervical curvature', name: 'Cervical curvature', x: 71, y: 12, span: [2.6, 20], lead: true, group: 'Curves and landmarks', about: 'the forward curve of the neck, which appears when a baby lifts its head' },
      { id: 'Vertebra prominens', name: 'Vertebra prominens', x: 70, y: 19.3, lead: true, group: 'Curves and landmarks', about: 'the long spinous process of the seventh cervical vertebra, easily felt at the base of the neck' },
      { id: 'Thoracic curvature', name: 'Thoracic curvature', x: 65, y: 40, span: [18.9, 64], lead: true, group: 'Curves and landmarks', about: 'the backward curve of the chest, present from birth' },
      ...
      { id: 'Lumbar curvature', name: 'Lumbar curvature', x: 83, y: 72, span: [61.2, 82.7], lead: true, group: 'Curves and landmarks', about: 'the forward curve of the lower back, which appears when a child begins to walk' },
      { id: 'Sacral curvature', name: 'Sacral curvature', x: 74, y: 87, span: [80, 93], lead: true, group: 'Curves and landmarks', about: 'the backward curve of the sacrum, present from birth' },
    ],
  }, {
    name: 'spineBack',
    title: 'Column from behind',
    items: [
      { id: 'Cervical vertebrae', name: 'Cervical vertebrae', x: 26, y: 12, span: [2.7, 19.4], group: 'Regions of the column', about: 'the seven vertebrae of the neck, the smallest and most mobile of the column' },
      { id: 'Thoracic vertebrae', name: 'Thoracic vertebrae', x: 27, y: 40, span: [18.2, 60.1], group: 'Regions of the column', about: 'the twelve vertebrae of the chest, each articulating with a pair of ribs' },
      { id: 'Lumbar vertebrae', name: 'Lumbar vertebrae', x: 27, y: 70, span: [60.7, 82.6], group: 'Regions of the column', about: 'the five vertebrae of the lower back, with the largest bodies of the column' },
