...
},
{
  ...
  questions: [
    ...
    { q: 'The patella is an example of which type of bone?',
      ...
      why: 'It sits inside a tendon crossing the knee. Note the textbook treats sesamoid as a special kind of SHORT bone, so a question may accept either framing.' }
  ]
},
{
  id: 'bio-ch7-2',
...
},
{
  ...
  questions: [
    { q: 'When a muscle contracts, which end moves?',
      ...
      why: 'The origin sits on the relatively fixed bone. Because the action happens at the insertion, the textbook describes the biceps brachii as flexing the elbow rather than the forearm.' },
...
},
{
  ...
  questions: [
    ...
    { q: 'What is the main function of the ligamentum capitis of the hip?',
      ...
      why: 'The textbook says outright that it seems to have little importance in holding the bones together. Deepening the socket is the acetabular labrum instead.' },
    ...
    { q: 'A torn meniscus heals slowly because fibrocartilage:',
      ...
      why: 'The same reason the chapter gives for ligament and cartilage injuries generally. A displaced fragment also jams between the surfaces and blocks movement.' },
...

{
  ...
  cards: [
    ...
    { fact: true, term: 'The three types of muscle', def: 'skeletal, smooth and cardiac' },
    { fact: true, term: 'The functions of skeletal muscle the chapter lists',
...

{
  ...
  cards: [
    ...
    { fact: true, term: 'The hormone example the chapter gives for smooth muscle',
...

{
  ...
  cards: [
    ...
    { fact: true, term: 'The two muscle pairs the book uses to show roles changing',
...

{
  ...
  questions: [
    { q: 'Which muscle is the primary extensor of the elbow?',
      ...
      why: 'It is the only muscle on the back of the arm. The anconeus assists but the book calls it a weak synergist.' },
...

{
  ...
  cards: [
    ...
    { term: 'Extensor digitorum longus', def: 'the muscle along the lateral leg just behind the tibialis anterior, arising from the lateral condyle of the tibia and the shaft of the fibula, its tendon dividing into four parts over the front of the ankle to reach the four lateral toes; it dorsiflexes the foot and extends those toes',
      note: "Deep fibular nerve. The book disagrees with itself about eversion: the prose lists 'dorsiflexion of the foot, eversion of the foot, and extension of the toes', while table 9.15 gives only 'dorsiflexion of foot, extends toes'. The tendon crosses to the lateral toes, so eversion is anatomically reasonable, but if a question offers eversion as an action of this muscle, know that the table does not support it." },
  ...
  questions: [
    ...
    { q: 'Which muscle inverts the foot?',
      ...
      why: 'The two fibularis muscles evert. Extensor hallucis longus also inverts, by pulling up on the medial portion of the foot, but the book names the deep posterior muscle as the invertor.' },
...

{
  ...
  cards: [
    ...
    { fact: true, term: 'The organization whose exercise recommendations the chapter cites',
...

{
  ...
  questions: [
    ...
    { q: 'A malignant tumor arising from connective tissue is a:',
      ...
      why: 'Carcinoma is the epithelial one, and myoma is benign. The -sarcoma ending marks connective tissue throughout the chapter.' },
...

{
  ...
  cards: [
    ...
    { fact: true, term: 'The muscle groups covered in this chapter',
