...
},
{
  ...
  cards: [
    ...
    { term: 'Zone of resting cartilage', def: 'the layer closest to the end of the bone, whose cells do not grow but anchor the plate' },
    { term: 'Zone of proliferating cartilage', def: 'the layer of young cells undergoing mitosis, which thickens the plate' },
    { term: 'Zone of hypertrophic cartilage', def: 'the layer of older cells enlarging, which is what actually lengthens the bone' },
    { term: 'Zone of calcified cartilage', def: 'the thin layer of dead cells and hardened matrix' },
  ...
  questions: [
    ...
    { q: 'Which zone of the epiphyseal plate is responsible for the bone actually lengthening?',
      choices: ['Zone of hypertrophic cartilage', 'Zone of proliferating cartilage',
        'Zone of resting cartilage', 'Zone of calcified cartilage'], answer: 0,
