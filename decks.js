...
},
{
  ...
  labels: [{
    ...
    items: [
      ...
      { id: 'Costal facet', name: 'Costal facet', x: 65, y: 41.5, side: 'L', lead: true, group: 'Curves and landmarks', about: 'the small facet on a thoracic vertebra where the head of a rib articulates' },
      { id: 'Intervertebral foramina', name: 'Intervertebral foramina', x: 62.5, y: 38.5, side: 'L', lead: true, group: 'Curves and landmarks', about: 'the openings between adjacent vertebrae through which the spinal nerves leave' },
