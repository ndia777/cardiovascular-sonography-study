...
},
{
  ...
  cards: [
    ...
    { term: 'CAPS', def: 'the gelatin-shelled dose form, as opposed to tablets',
      note: 'The shared notes give this simply as "capsules".' },
    { term: 'PT', def: 'patient' },
    ...
    { term: 'CONTRA', def: 'against, as in a reason a drug should not be given',
      note: 'The shared notes give this as "contra indication / against".' },
    ...
    { term: 'H2O2', also: ['H202'], def: 'hydrogen peroxide',
      note: 'Written "H202" in the shared notes, with a zero. The chemical formula is H2O2, two hydrogens and two oxygens. Both spellings are accepted here.' },
    ...
    { term: 'SUPP', also: ['SUPPOSE'], def: 'the dose form inserted into a body opening rather than swallowed',
      note: 'The shared notes have "Suppose", which looks like a slip for the standard "Supp". It stands for suppository. Both are accepted here.' },
...
},
{
  ...
  cards: [
    ...
    { term: 'Compression fracture', def: 'a crush fracture of a vertebra, commonly caused by osteoporosis',
      note: 'The study guide lists this one twice, once as "vertebral crush fracture" and once as "osteoporosis-related fracture". Both are the same break; this card carries both halves.' },
    ...
    { term: 'Paget\'s disease', def: 'a chronic bone disease of unknown cause, marked by abnormal breakdown and formation of bone',
      note: 'The study guide lists this one twice, once as "chronic bone disease with abnormal bone breakdown and formation" and once as "chronic bone disease of unknown cause". Both halves are on this card.' },
...
},
{
  ...
  questions: [
    ...
    { q: 'Blood calcium falls. Which hormone acts, on which cells?',
      ...
      why: 'Low calcium must be corrected by taking it OUT of bone, which needs the cells that break bone down. Both halves have to be right — the distractors each get one half correct.' },
...
/* ---------------------------------------------------------------------------
   DOSAGE CALCULATION
   ---------------------------------------------------------------------------
   Word problems, worked with D over H times Q. Recall only: a problem has one
   sensible way to be studied, and flipping it as a flashcard grades nothing.

   Recall shows the definition and asks for the term, so no card can ask for a
   number already printed in the problem. That rules out "which number is H" as
   a typed question, and rightly — H is stated in the order, and reading it back
   is copying rather than calculating. Every answer below has to be built: a
   weight converted, a stock strength converted, a dose computed from mg/kg, or
   the final amount. The formula itself, and the unit conversions it leans on,
   are taught by the notes shown after each answer. */
{
  ...
  /* RECALL ONLY. A word problem has one sensible way to be studied: work it out
     ...
     final amount. Which number is which is named in the note that
