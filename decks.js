...

{
  ...
  cards: [
    ...
    { term: 'Isotonic solution',  def: 'the SAME solute concentration as the cell — equal salt inside and out' },
    { term: 'Hypertonic solution',def: 'a HIGHER solute concentration than body fluids — more salt in the solution than in the cell' },
    { term: 'Hypotonic solution', def: 'a LOWER solute concentration than body fluids — less salt in the solution than in the cell' },
  ...
  questions: [
    ...
    { q: 'A red blood cell is placed in a hypertonic solution. What happens?',
      ...
      why: 'Remember the rule from your notes: "where salt goes, water follows." Hypertonic = more salt outside → water follows it out.' },
