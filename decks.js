...

{
  ...
  cards: [
    { term: 'Right atrium',        def: 'the chamber deoxygenated blood enters when it returns to the heart' },
    ...
    { term: 'Standard limb leads',           def: 'Lead I, Lead II and Lead III' },
    { term: 'Precordial leads, chest leads', def: 'V1 through V6' },
    { term: '10 mm',                         def: 'the height of a proper standardization mark on an ECG' },
  ...
  questions: [
    ...
    { q: 'What is true of a treadmill stress test?',
      choices: [
        'It must be monitored closely by the provider',
