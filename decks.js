...
},
{
  ...
  labels: [{
    ...
    items: [
      ...
      { id: 'Vertebra prominens', name: 'Vertebra prominens', x: 66, y: 19.8, lead: true, group: 'Curves and landmarks', about: 'the long spinous process of the seventh cervical vertebra, easily felt at the base of the neck' },
      ...
      { id: 'Intervertebral foramina', name: 'Intervertebral foramina', x: 62.5, y: 38.5, lead: true, group: 'Curves and landmarks', about: 'the openings between adjacent vertebrae through which the spinal nerves leave' },
    ...
    items: [
      { id: 'Cervical vertebrae', name: 'Cervical vertebrae', x: 26, y: 12, span: [2.7, 19.4], hi: 'vcCervical', group: 'Regions of the column', about: 'the seven vertebrae of the neck, the smallest and most mobile of the column' },
      { id: 'Thoracic vertebrae', name: 'Thoracic vertebrae', x: 27, y: 40, span: [18.2, 60.1], hi: 'vcThoracic', group: 'Regions of the column', about: 'the twelve vertebrae of the chest, each articulating with a pair of ribs' },
      { id: 'Lumbar vertebrae', name: 'Lumbar vertebrae', x: 27, y: 70, span: [60.7, 82.6], hi: 'vcLumbar', group: 'Regions of the column', about: 'the five vertebrae of the lower back, with the largest bodies of the column' },
      { id: 'Sacrum', name: 'Sacrum', x: 34, y: 86, group: 'Regions of the column', about: 'five vertebrae fused into one triangular bone wedged between the hip bones' },
      { id: 'Coccyx', name: 'Coccyx', x: 28.4, y: 94.5, lead: true, group: 'Regions of the column', about: 'the tailbone, three to five tiny fused vertebrae at the base of the column' },
    ],
  }],
  region: {
    name: 'spineWhole',
