...
},
{
  ...
  label: {
    ...
    items: [
      ...
      { id: 'Ethmoid bone', name: 'Ethmoid bone', x: 69.6, y: 45.8, lead: true, group: 'Bones of the skull', about: 'a light bone in the medial wall of the orbit and the roof of the nasal cavity' },
      { id: 'Lacrimal bone', name: 'Lacrimal bone', x: 70.8, y: 44.8, lead: true, group: 'Bones of the skull', about: 'the smallest facial bone, in the medial wall of the orbit' },
