   ...
   examined separately. */
{
  ...
  figure: {
    ...
    parts: [
      ...
      { id: 'Sweat pore', x: 31, y: 26, about: 'the opening where a sweat duct reaches the surface' },
      { id: 'Epidermis', x: 24, y: 34, about: 'the outer layer — no blood supply of its own, and the layer that keratinises' },
      ...
      { id: 'Hair follicle', x: 45, y: 62, about: 'the sheath the hair grows inside, running down into the dermis' },
      ...
      { id: 'Nerve fiber', x: 23, y: 58, about: 'the threads carrying sensation from the skin back to the spinal cord' },
