   ...
   examined separately. */
{
  ...
  cards: [
    ...
    /* ---- added from the notes/practice-question gap check ---- */
    { term: 'Desmosomes', def: 'the junctions that thicken in older keratinocytes and fasten them tightly to one another' },
