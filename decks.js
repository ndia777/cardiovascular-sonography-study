...

{
  ...
  cards: [
    ...
    {"term":"Cilia & flagella","def":"motile extensions of the cell membrane","note":"Both are built from nine groups of three microtubules."},
    ...
    {"term":"Flagellum (what it does)","def":"whips to move the WHOLE cell","note":"The sperm tail is the only flagellum in the human body, and a cell has just one."},
    ...
    {"term":"Pores, channels & carriers","def":"transport small molecules and ions across the membrane","note":"They also transduce signals."},
