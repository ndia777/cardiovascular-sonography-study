...
},
{
  ...
  cards: [
    ...
    { term: 'The four things bones do, as the slides list them', def: 'support and protect softer tissues, provide points of attachment for muscles, house blood-producing cells, and store inorganic salts', fact: true },
...
},
{
  ...
  cards: [
    ...
    { fact: true, term: 'The most commonly replaced joint, according to the slides', def: 'the hip',
      note: 'The textbook puts the knee first and the hip second. The slides carry a 2019 copyright, so the ranking may simply have moved since.' },
